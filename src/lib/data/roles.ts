...
export const experienceLevels: ExperienceLevel[] = ['Junior', 'Intermediate', 'Senior'];
...
export const availableRoles: RoleData[] = [
	{
		...
		description: 'Manages Amazon FBA accounts, listings, inventory, and advertising campaigns.',
		costs: {
	...
	},
	{
		id: 'web-dev',
		name: 'Web Developer',
		description: 'Develops and maintains websites and web applications using various technologies.',
		costs: {
	...
	},
	{
		...
		description: 'Provides administrative, technical, or creative assistance to clients remotely.',
		costs: {
	...
	},
	{
		id: 'accountant',
		name: 'Accountant',
		description: 'Prepares and examines financial records, ensuring accuracy and compliance.',
		costs: {
	...
	},
	{
		id: 'bookkeeper',
		name: 'Bookkeeper',
		description: 'Records daily financial transactions and manages financial data entry.',
		costs: {
	...
	},
	{
		...
		description: 'Handles customer inquiries, complaints, and provides information about products/services.',
		costs: {
	...
	},
	{
		...
		description: 'Enters and updates data into databases and computer systems accurately and efficiently.',
		costs: {
	...
	},
	{
		...
		description: 'Develops and implements online marketing strategies including SEO, SEM, and social media.',
		costs: {
	...
	},
	{
		id: 'seo-specialist',
		name: 'SEO Specialist',
		description: 'Optimizes websites and content to improve search engine rankings and visibility.',
		costs: {
	...
	},
	{
		...
		description: 'Manages social media presence, content creation, and engagement strategies.',
		costs: {
	...
	},
	{
		id: 'content-writer',
		name: 'Content Writer',
		description: 'Creates engaging and informative written content for websites, blogs, and marketing.',
		costs: {
	...
	},
	{
		...
		description: 'Plans, executes, and oversees projects to ensure they are completed on time and within budget.',
		costs: {
	...
	},
	{
		id: 'hr-specialist',
		name: 'HR Specialist',
		description: 'Manages recruitment, employee relations, benefits administration, and HR policies.',
		costs: {
	...
	},
	{
		id: 'recruiter',
		name: 'Recruiter',
		description: 'Sources, screens, and interviews candidates to fill job openings.',
		costs: {
			Junior: { hireOnshore: 5000, hireWithStaffStack: 1800 },
	...
	},
	{
		...
		description: 'Sells products or services to businesses or consumers, managing customer relationships.',
		costs: {
			Junior: { hireOnshore: 4500, hireWithStaffStack: 1600 },
	...
	},
	{
		...
		description: 'Provides high-level administrative support to executives and managers.',
		costs: {
			Junior: { hireOnshore: 4800, hireWithStaffStack: 1700 },
	...
	},
	{
		id: 'ui-ux-designer',
		name: 'UI/UX Designer',
		description: 'Designs user interfaces and user experiences for websites and applications.',
		costs: {
	...
	},
	{
		id: 'video-editor',
		name: 'Video Editor',
		description: 'Assembles recorded raw material into a finished product suitable for broadcasting.',
		costs: {
	...
	},
	{
		id: '3d-artist',
		name: '3D Artist',
		description: 'Creates 3D models, animations, and visual effects for various media.',
		costs: {
	...
	},
	{
		id: 'qa-tester',
		name: 'QA Tester',
		description: 'Tests software to identify bugs and ensure quality before release.',
		costs: {
	...
	},
	{
		...
		description: 'Analyzes business needs and processes, recommending solutions and improvements.',
		costs: {
...
export function getRoleCosts(roleId: string, level: ExperienceLevel): RoleCost | undefined {
	const role = availableRoles.find((r) => r.id === roleId);
	return role?.costs[level];
}

// Function to calculate savings
export function calculateSavings(onshoreCost: number, staffStackCost: number): number {
