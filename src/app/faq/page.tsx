...
export const metadata = {
  ...
  description: "Find answers to common questions about offshore staffing with Staff Stack. Learn about our processes, benefits, and how to get started.",
};
...
export default function FAQPage() {
  const faqCategories = [
    ...
    },
    {
      ...
      faqs: [
        {
          question: "How much does it cost to hire offshore staff in the Philippines?",
          answer: "Costs vary depending on the role, experience level, and specific skill requirements. However, most clients achieve 40-70% cost savings compared to hiring equivalent positions locally in the US, Australia, UK, or other Western countries. We provide transparent pricing with a simple monthly fee structure that includes the employee's salary, our management fee, office facilities, equipment, HR management, and all statutory benefits. Contact us for a detailed quote based on your specific requirements."
        },
        {
          question: "Are there any hidden costs or setup fees?",
          answer: "No, we pride ourselves on transparent pricing. Our monthly fee is all-inclusive, covering recruitment, employee salary, benefits, office space, equipment, HR management, and ongoing support. There are no setup fees or hidden charges. The only potential additional costs would be for any specialized equipment or software that your specific operations might require beyond our standard provisions, which we would discuss and agree upon in advance."
        },
        {
        ...
        <div className="container mx-auto">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl font-lexend font-light max-w-3xl">
              Find answers to common questions about offshore staffing with Staff Stack
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-[#0f2c4a]/5 p-8 rounded-xl text-center mt-12">
              ...
              <p className="text-lg text-slate-700 mb-6 max-w-2xl mx-auto">
                Our team is ready to help you understand how offshore staffing can benefit your business and answer any specific questions you may have.
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                ...
                <p className="text-slate-700 mb-4">
                  Learn about our end-to-end process for building and managing your offshore team.
                </p>
                <Button
                  variant="outline"
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                ...
                <p className="text-slate-700 mb-4">
                  Browse the wide range of positions and skill sets available for your offshore team.
                </p>
                <Button
                  variant="outline"
                  className="w-full border-[#09d8f5] text-[#0f2c4a] hover:bg-[#09d8f5]/10 font-medium"
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                ...
                <p className="text-slate-700 mb-4">
                  Read success stories from businesses that have partnered with Staff Stack.
                </p>
                <Button
                  variant="outline"
                  className="w-full border-[#09d8f5] text-[#0f2c4a] hover:bg-[#09d8f5]/10 font-medium"
