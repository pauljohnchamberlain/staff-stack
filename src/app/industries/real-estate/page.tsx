...
export const metadata = {
  ...
  description:
    "Build your dedicated real estate team with skilled offshore professionals from the Philippines. Our staff helps streamline your real estate operations.",
};
        ...
        <div className="container mx-auto">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl font-lexend font-light max-w-3xl">
              Build your dedicated real estate team with skilled professionals
              in the Philippines
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              ...
              <p className="text-lg text-slate-700 mb-8">
                Our offshore real estate professionals provide comprehensive
                support for property management companies, real estate agencies,
                and brokerages. With excellent organizational skills and
                industry knowledge, they help streamline operations and improve
                client service while allowing your local team to focus on
                closing deals.
              </p>
            ...
            <div>
              ...
              <div className="bg-slate-50 p-8 rounded-xl border border-slate-100">
                ...
                <p className="text-lg text-slate-700 mb-6">
                  Get started today and build a dedicated real estate support
                  team that handles administrative tasks while you focus on
                  growing your business and serving clients.
                </p>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white p-8 rounded-xl shadow-xs">
              <p className="text-lg italic font-inter text-slate-600 mb-6">
                "Our real estate agency has seen tremendous growth since
                partnering with Staff Stack. Their virtual assistants handle all
                our listing coordination, paperwork, and initial client
                inquiries with incredible efficiency. This has freed our agents
                to focus on showings and closings, resulting in a 40% increase
                in transactions within the first six months."
              </p>
