...
export const metadata = {
  ...
  description: "Read testimonials from businesses who've partnered with Staff Stack for offshore staffing solutions in the Philippines.",
};
...
export default function TestimonialsPage() {
  const testimonials = [
    ...
    {
      id: "testimonial-3",
      quote: "The recruiting process at Staff Stack is remarkably thorough. They took the time to deeply understand our business needs, technical requirements, and company culture before presenting candidates. This upfront investment paid off – every team member they've brought on has been not just technically qualified, but a perfect fit for our team dynamics and work style.",
      name: "David Chen",
    ...
    {
      id: "testimonial-6",
      quote: "What impresses me most about Staff Stack is their ability to find specialized talent. We needed professionals with very specific industry knowledge and technical skills – a combination that was nearly impossible to find locally. Staff Stack not only found qualified candidates but gave us multiple options to choose from, all within our budget constraints.",
      name: "Sarah Patel",
        ...
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-slate-700 mb-10">
              Our clients come from diverse industries and backgrounds, but they share a common experience – successful partnerships with Staff Stack that have transformed their businesses. Here are their stories in their own words.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
              ...
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-100">
                ...
                <p className="text-[#0f2c4a] font-medium">Client Satisfaction</p>
              </div>
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-100">
              ...
              {testimonials.map((testimonial) => (
                ...
                >
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                      <p className="font-lexend font-medium text-lg text-[#0f2c4a]">{testimonial.name}</p>
                      <p className="text-slate-600">{testimonial.title}</p>
                      <p className="text-sm text-slate-500">{testimonial.industry}</p>
                    </div>
                    <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {videoTestimonials.map((video) => (
                ...
                >
                  ...
                  <div className="p-4">
                    <h3 className="font-lexend font-medium text-[#0f2c4a]">{video.title}</h3>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {clientLogos.map((client) => (
                ...
                >
                  ...
                  <p className="font-lexend font-medium text-[#0f2c4a]">{client.name}</p>
        ...
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl font-light mb-10 max-w-2xl mx-auto">
              Join hundreds of businesses who have transformed their operations with Staff Stack offshore staffing solutions.
            </p>
