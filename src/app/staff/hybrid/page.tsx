...
export const metadata = {
  ...
  description: "Flexible hybrid work arrangements for your offshore team combining office and remote work. Get the best of both worlds with our hybrid staffing solutions.",
};
...
export default function HybridStaffPage() {
  const benefits = [
    {
      ...
      description: "Combine office days for collaboration and team building with remote days for focused work and improved work-life balance."
    },
    {
      title: "Expanded Talent Access",
      description: "Attract a wider pool of candidates who value flexible work arrangements while still maintaining in-person connection."
    },
    {
      title: "Cost Efficiency",
      description: "Optimize operational costs with reduced office space requirements while maintaining professional infrastructure."
    },
    {
      title: "Improved Productivity",
      description: "Staff can choose the environment best suited for different types of work, enhancing focus and efficiency."
    },
    {
      title: "Enhanced Retention",
      description: "Higher employee satisfaction and loyalty from staff who appreciate flexible work arrangements."
    },
    {
      title: "Business Continuity",
      description: "Built-in resilience with staff equipped to work effectively from multiple locations."
    }
  ];
  ...
  const hybridModels = [
    {
      title: "Split Week",
      description: "Staff work predetermined days in the office (typically 2-3 days) and the remainder from home, following a consistent schedule."
    },
    {
      title: "Project-Based",
      description: "Office attendance based on project phases requiring collaboration, with independent work done remotely."
    },
    {
      title: "Team Rotation",
      description: "Different teams alternate office use on specified days to optimize space while ensuring cross-team collaboration."
    },
    {
      title: "Core Hours",
      description: "Mandatory in-office presence during specific core hours or days, with flexibility outside those times."
    }
  ];
        ...
        <div className="container mx-auto">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl font-lexend font-light max-w-3xl">
              Flexible work arrangements that combine office and remote work for optimal results
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="mb-12">
              ...
              <p className="text-lg text-slate-700">
                Our hybrid staffing model offers the perfect balance between traditional office-based teams and fully remote staff. This flexible approach combines the collaboration and culture benefits of in-person work with the autonomy and lifestyle advantages of remote arrangements, creating an optimized environment for productivity and staff satisfaction.
              </p>
            </div>
            ...
            <div className="mb-16">
              ...
              <p className="text-lg text-slate-700 mb-8">
                We offer several hybrid work arrangements that can be tailored to your business needs, team dynamics, and operational requirements.
              </p>
            ...
            <div className="mb-16">
              ...
              <p className="text-lg text-slate-700 mb-8">
                We provide all the tools, infrastructure, and management systems needed to ensure your hybrid team functions seamlessly across multiple work environments.
              </p>
            ...
            <div className="text-center">
              ...
              <p className="text-lg text-slate-700 mb-8 max-w-2xl mx-auto">
                Get started today with our expert recruitment team to build a flexible hybrid workforce tailored to your business needs.
              </p>
            ...
            <div className="bg-white p-8 rounded-xl shadow-xs">
              ...
              <div className="flex items-center justify-center">
                ...
                <div className="ml-4 text-left">
                  ...
                  <p className="text-sm text-slate-500">CTO, Agile Software Innovations</p>
                </div>
              </div>
            </div>
          </div>
